...
public class TeamScotland extends AppCompatActivity {


    static final String URL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.team.profile%20where%20team_id%3D16&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0";
    ArrayList<HashMap<String, String>> scosquad = new ArrayList<HashMap<String, String>>();
   ...
   /* static final String player28F="player28F";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teamscotland);
    ...
    public class BackGroundClass extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result)
        {
            ...
            ListAdapter adapter = new SimpleAdapter(ctx,scosquad,R.layout.activity_team_scotland,new String[]{ player1F,player1L,player2F,player2L,player3F,player3L,player4F,player4L,player5F,player15L,player6F,player6L,player7F,player7L,player8F,player8L,player9F,player9L,player10F,player10L,
                    ...
                    }, new int[]
                    {
                           ...
                           // R.id.player21F,R.id.player21L, R.id.player22F,R.id.player22L,R.id.player23F,R.id.player23L,R.id.player24F,R.id.player24L,R.id.player25F,R.id.player25L,R.id.player26F,R.id.player26L,R.id.player27F,R.id.player27L,
                    });
