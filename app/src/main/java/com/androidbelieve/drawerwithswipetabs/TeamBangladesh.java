...
public class TeamBangladesh extends AppCompatActivity {


    static final String URL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.team.profile%20where%20team_id%3D2%20&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0";
    ArrayList<HashMap<String, String>> bansquad = new ArrayList<HashMap<String, String>>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teambangladesh);
    ...
    public class BackGroundClass extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result)
        {
            ...
            ListAdapter adapter = new SimpleAdapter(ctx,bansquad,R.layout.activity_team_bangladesh,new String[]{ player1F,player1L,player2F,player2L,player3F,player3L,player4F,player4L,player5F,player15L,player6F,player6L,player7F,player7L,player8F,player8L,player9F,player9L,player10F,player10L,
