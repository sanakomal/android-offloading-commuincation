...
public class TeamAfghanistan extends AppCompatActivity {


    static final String URL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.team.profile%20where%20team_id%3D1188&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0";
    ArrayList<HashMap<String, String>> afgsquad = new ArrayList<HashMap<String, String>>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teamafghanistan);
    ...
    public class BackGroundClass extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String result)
        {
            ...
            ListAdapter adapter = new SimpleAdapter(ctx,afgsquad,R.layout.activity_team_afghanistan,new String[]{ player1F,player1L,player2F,player2L,player3F,player3L,player4F,player4L,player5F,player15L,player6F,player6L,player7F,player7L,player8F,player8L,player9F,player9L,player10F,player10L,
                    ...
                    player31F,player31L,player32F,player32L,player33F,player33L,player34F,player34L,player35F,player35L,player36F,player36L,player37F,player37L,player38F,player38L,player39F,player39L}, new int[]
                    {
                            ...
                            R.id.player31F,R.id.player31L,R.id.player32F,R.id.player32L,R.id.player33F,R.id.player33L,R.id.player34F,R.id.player34L,R.id.player35F,R.id.player35L,R.id.player36F,R.id.player36L,R.id.player37F,R.id.player37L,R.id.player38F,R.id.player38L,R.id.player39F,R.id.player39L,
                    });
