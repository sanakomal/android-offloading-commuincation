...
public class TeamIreland extends AppCompatActivity {


    static final String URL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.team.profile%20where%20team_id%3D13&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0";
    ArrayList<HashMap<String, String>> irelandsquad = new ArrayList<HashMap<String, String>>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teamireland);
...
ProgressDialog progressDialog;
        ...
        protected void onPostExecute(String result)
        {
            ...
            ListAdapter adapter = new SimpleAdapter(ctx,irelandsquad,R.layout.activity_team_ireland,new String[]{ player1F,player1L,player2F,player2L,player3F,player3L,player4F,player4L,player5F,player15L,player6F,player6L,player7F,player7L,player8F,player8L,player9F,player9L,player10F,player10L,
                    ...
                    player21F,player21L,player22F,player22L,player23F,player23L,player24F,player24L,}, new int[]
                    {
                            ...
                            R.id.player21F,R.id.player21L, R.id.player22F,R.id.player22L,R.id.player23F,R.id.player23L,R.id.player24F,R.id.player24L,
                    });
