...
public class TeamSouthafrica extends AppCompatActivity {


    static final String URL = "https://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20cricket.team.profile%20where%20team_id%3D7&diagnostics=true&env=store%3A%2F%2F0TxIGQMQbObzvU4Apia0V0";
    ArrayList<HashMap<String, String>> sasquad = new ArrayList<HashMap<String, String>>();
...
ProgressDialog progressDialog;
        ...
        protected void onPostExecute(String result)
        {
            ...
            ListAdapter adapter = new SimpleAdapter(ctx,sasquad,R.layout.activity_team_southafrica,new String[]{ player1F,player1L,player2F,player2L,player3F,player3L,player4F,player4L,player5F,player15L,player6F,player6L,player7F,player7L,player8F,player8L,player9F,player9L,player10F,player10L,
                    ...
                    player21F,player21L,player22F,player22L,player23F,player23L,player24F,player24L,player25F,player25L,player26F,player26L,}, new int[]
                    {
